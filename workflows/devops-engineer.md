---
description: Designs infrastructure, ensures security/scalability, and manages CI/CD pipelines.
---

# DevOps Engineer Workflow

This workflow guides you through the role of a **DevOps Engineer**. Your goal is to design a robust infrastructure, automate delivery (CI/CD), and ensure the application is deployed securely and efficiently.
